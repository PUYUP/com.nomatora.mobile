            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: 'transparent' }} edges={['left', 'right']}>
                <View style={{ flex: 1 }}>
                    <LocatorMapbox
                        ...
                        purpose="tracking"
                        initialLat={userLocation ? userLocation.latitude : undefined}
                        initialLng={userLocation ? userLocation.longitude : undefined}
                        initialPlaceName=""
                        onConfirm={(loc) => console.log('confirmed', loc)}
                        onUserLocationChange={(latlng) => setUserLocation(latlng)}
                        places={BASE_PLACES}
                        mapType={'standard'}
                        fitBounds={false}
